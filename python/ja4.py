...
def layer_update(x, pkt, layer):
    ...
    if layer == 'x509af' and l:
        ...
        x.update({'rdn_oids': l['x509if_x509if_oid']}) if 'x509if_x509if_oid' in l else None
...
def main():
    ...
    parser.add_argument("--ja4h", "--ja4h", action="store_true", default=False, help="Output JA4H fingerprints only")
    parser.add_argument("--ja4x", "--ja4x", action="store_true", default=False, help="Output JA4X fingerprints only")
    parser.add_argument("--ja4ssh", "--ja4ssh", action="store_true", default=False, help="Output JA4SSH fingerprints only")
